...
public class BaseBallGameLogic {
	...
	//채번하는 메소드가 필요하다.
	// -> 메소드 중심의 코딩을 전개하기(재사용성의 첫 단추)
	// 언제 ? ⓐ 새 게임을 눌렀을 때 ⓑ 정답을 눌렀을 때
	...
	/******************************************************************************************
	 * 
	 * @param input jp_center속지의 남쪽에 JTextField가 있어서 숫자가 있는데 이것을 문자로 바꿔줌.
	 * @return 1s 1b, 2s 1b -> 2자리는 숫자도 같고, 위치도 같을 때
	 * 1회 : 256 -> 1s 0b
	 * 2회 : 356 -> 1s 1b
	 * 이렇게 나와야하기 때문에, 전역변수는 회차를 말하는 'cnt' (static 고려 대상이긴 한데, 바뀌어야 함)
	 * 지역변수는 strike, ball(static은 고려대상이 아니다.) 
	 ******************************************************************************************/
