...
public class BaseBallGameView1 {
	BaseBallGameLogic1 bbgLogic1 = new BaseBallGameLogic1();
	BaseBallGameEvent1 bbgEvent1 = new BaseBallGameEvent1(this, bbgLogic1);
	...
	public void initDisplay(){
		...
		for(int i=0;i<4;i++){
			...
			jp_east.add(jbtns[i]);
			//이 부분을 왜 이렇게 하는지 잘 모르겠음...
			jbtns[i].addActionListener(bbgEvent1);
		}
...
//		jbtns[0].setBackground(newColor);
	...
	public static void main(String[] args) {
		BaseBallGameView1 bbgView1 = new BaseBallGameView1();
		bbgView1.initDisplay();
	}
}
