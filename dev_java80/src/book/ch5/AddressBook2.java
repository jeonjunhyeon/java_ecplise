...
//   static AddressBook2 aBook = new AddressBook2();
   ...
   public void actionPerformed(ActionEvent ae) {
      ...
      if(obj == jmi_selALL) {
         ...
         ResultSet 			rs 		= null;
/////////////////////////////////////[[ 조회결과를 처리  ]]////////////////////////////////////
         String sql = "SELECT deptno, dname, loc FROM dept"; // 102번 PreparedStatement를 통해 sql문을 실행할 수 있다.
         DeptVO dVOS[] = null;
         try {
            //연결통로확보 하기
   ...
   /////////////////////////////////////[[ 조회결과를 처리  ]]////////////////////////////////////
            ...
            try {
               ...
               if(rs.next()) {
                  ...
                  dVO = new DeptVO();//NullPointerException 를 피해서 테스트 할 수 있다.
               }
    	...
    	//한 건을 먼저 선택하세요. - deptno
          ...
          //선택된 로우가 한 개 이상인 경우
             ...
             JOptionPane.showMessageDialog(jf, "수정은 한번에 한건만 선택하세요","Error",JOptionPane.INFORMATION_MESSAGE);
             return;
          }
